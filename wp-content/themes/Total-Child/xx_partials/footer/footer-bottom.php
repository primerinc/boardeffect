...
<?php if( is_page(8618) ) { ?>
	<script>
		function revSlideSecurity() {
			jQuery('html, body').animate({
		        scrollTop: jQuery(".vc_custom_1464812995215").offset().top - (jQuery("#site-header").height() -20)
		    }, 1000);
		}
	</script>
<?php } ?>
<?php if( is_page(8642) ) { ?>
	<script>
		function revSlideServices() {
			jQuery('html, body').animate({
		        scrollTop: jQuery(".vc_custom_1463673274189").offset().top - (jQuery("#site-header").height() -20)
		    }, 1000);
		}
	</script>
<?php }