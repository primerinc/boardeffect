...
<a href="#" class="toggle-bar-btn fade-toggle open-togglebar <?php echo wpex_get_mod( 'toggle_bar_visibility' ); ?>" data-icon="<?php echo $icon; ?>" data-icon-hover="<?php echo $active_icon; ?>">
