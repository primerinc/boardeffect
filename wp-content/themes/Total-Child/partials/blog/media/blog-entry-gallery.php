						...
						// Display attachment image
							...
							<div class="wpex-slider-media clr">
								...
								if ( $lightbox_enabled ) : ?>
									...
									<a href="<?php echo $lightbox_url; ?>" title="<?php echo $attachment_alt; ?>" data-title="<?php echo $attachment_alt; ?>" data-type="image" class="wpex-lightbox-group-item<?php wpex_entry_image_animation_classes(); ?>"><?php echo $attachment_html; ?></a>
