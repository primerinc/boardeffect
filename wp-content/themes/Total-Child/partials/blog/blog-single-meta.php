...
<ul class="<?php echo $classes; ?>">
	...
	foreach ( $sections as $section ) : ?>
		...
		<?php if ( 'author' == $section ) : ?>
			<li class="meta-author"><!--<span class="fa fa-user"></span>--><span class="vcard author"<?php wpex_schema_markup( 'author_name' ); ?>>Written by <span class="fn"><?php 
				// Added code for Co-Author Plug-in
